...
The `<ClientOnly>` component is used for purposefully rendering a component only on the client side.
...
<template>
  <div>
    <Sidebar />
    <!-- The <Comment> component will only be rendered on the client side -->
